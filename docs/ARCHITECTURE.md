...
11. `AnalysisTimelineWriter` records one CSV row per rendered or recorded frame, including resolved depth/color settings and bar/downbeat/phrase/build-tension sync columns.
