                         ...
                         std::string& error)
{
    ...
    for (int frameIndex = 0; frameIndex < framesToWrite; ++frameIndex) {
        ...
        if (!timeline.write(AnalysisTimelineEntry{
                ...
                geometry.interactionParallax3D,
                geometry.interactionFocus3D,
                geometry.interactionDepthPeel3D,
                ...
                geometry.songIdentityConfidence3D,
                geometry.songIdentityContinuity3D,
                ...
                geometry.sceneRoleMemory3D,
                geometry.sceneRoleTransition3D,
                geometry.sceneRoleContrast3D,
