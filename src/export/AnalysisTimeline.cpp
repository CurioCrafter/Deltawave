...
bool AnalysisTimelineWriter::open(const std::filesystem::path& path, std::string& error)
{
    ...
    output_ << "frame,timeSeconds,mode,palette,motionStyle,hueShift,depth3D,objectDensity3D,interactionDepth,lightingGlow,"
            ...
            << "scene3DName,sceneIntent,songIdentity,songIdentityConfidence3D,songIdentityContinuity3D,"
            ...
            << "cameraMotion3D,cameraContinuity3D,interactionParallax3D,interactionFocus3D,interactionDepthPeel3D,"
            ...
            << "roleMemory3D,roleTransition3D,roleContrast3D,"
            << "primitiveCount\n";
    if (!output_) {
...
bool AnalysisTimelineWriter::write(const AnalysisTimelineEntry& entry, std::string& error)
{
    ...
    output_ << entry.frameIndex << ","
            ...
            << '"' << entry.songIdentityName << '"' << ","
            << std::setprecision(3) << entry.songIdentityConfidence3D << ","
            << std::setprecision(3) << entry.songIdentityContinuity3D << ","
            ...
            << std::setprecision(3) << entry.interactionParallax3D << ","
            << std::setprecision(3) << entry.interactionFocus3D << ","
            << std::setprecision(3) << entry.interactionDepthPeel3D << ","
            ...
            << std::setprecision(3) << entry.sceneRoleMemory3D << ","
            << std::setprecision(3) << entry.sceneRoleTransition3D << ","
            << std::setprecision(3) << entry.sceneRoleContrast3D << ","
